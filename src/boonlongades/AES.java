...
public class AES {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /**
         * //testkeyexpansion(); //testsubByte(); //testshiftrow();
         * //testMixColumns(); //testAddRoundKey(); //testencryptECB();
         * //invTestshift4row(); testinvMixColumns();
         *
         * //testinvSubByte(); //	testencryptECB(); //testencryptCBC();
         * //testdecryptCBC(); //testdecryptECB();
         */
    }
